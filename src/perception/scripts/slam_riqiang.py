...
class fusion_node_t(Node):
    def __init__(self):
        ...
        self.declare_parameter('loc_to_map',[0.46876+0.26775,-0.08475-0.0815,0.0]) # slam原点到地图左下角的偏移 右手系
        ...
        self.tf_yaw_diff = 0.0  # 用于存储yaw的偏差
        #轮式里程计相关
        self.odom_x=0.0
        self.odom_y=0.0
        self.odom_yaw=0.0
    ...
    def fusion_callback(self):
        ...
        #发布轮式偏移的tf
            if laser_odom_x != 0.0 and laser_odom_y != 0.0:
