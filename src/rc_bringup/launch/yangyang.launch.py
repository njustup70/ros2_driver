...
def generate_launch_description():
    ...
    fusion_node=Node(
        ...
        parameters=[
            ...
            { 'loc_to_map':[0.46876,-0.08475-0.025,0.017453292]},  # slam原点到地图左下角的偏移 右手系
            {'base_to_laser': [-0.23751, -0.24275, 0.017453292]},  # 激光雷达到base_link的偏移 右手系
    ...
    odom_to_transform = ComposableNode(
        ...
        parameters=[{
            ...
            'frame_id': 'odom',  # 参考坐标系
            'translation': {'x': 0.23125+0.23751+0.26775, 'y': 7.83375, 'z': 0.0}, 
